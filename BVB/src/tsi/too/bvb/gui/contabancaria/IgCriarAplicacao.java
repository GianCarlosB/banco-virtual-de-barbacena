...
/** Classe que define a GUI de criação de aplicação do sistema BVB
 * 
...
public class IgCriarAplicacao extends JDialog {
	...
	/** Cria uma instância da janela de criação de aplicação do sistema BVB
	 * @param janelaPai <code>Window</code> com a janela pai da caixa de diálogo <code>IgCriarAplicacao</code>
